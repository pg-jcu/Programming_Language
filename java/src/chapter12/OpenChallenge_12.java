...
public class OpenChallenge_12 extends JFrame {
	...
	class ImagePanel extends JPanel {
		...
		public ImagePanel() {
			img = new ImageIcon("C:\\\\Users\\\\Jeong\\\\Desktop\\\\폴더\\\\2020 2학기\\\\강의) 모바일웹\\\\기말\\\\img\\\\book\\\\잡문집.jpg").getImage(); // 패널의 배경 이미지
		...
		public void paintComponent(Graphics g) {
			...
			g.setClip(clipX, clipY, 50, 50); // 클리핑 영역 지정, 클리핑 영역 크기 50x50
