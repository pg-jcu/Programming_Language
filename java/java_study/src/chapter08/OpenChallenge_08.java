...
public class OpenChallenge_08 {
	...
	public void run() {
		...
		Words words = new Words("C:\\Users\\Jeong\\eclipse-workspace\\java_study\\java_study\\src\\chapter08\\words.txt"); // words.txt 파일의 모든 단어를 읽어 벡터에 저장한다.		
		while(true) {
	...
	public static void main(String[] args) {
		OpenChallenge_08 app = new OpenChallenge_08();
		app.run();
	}
