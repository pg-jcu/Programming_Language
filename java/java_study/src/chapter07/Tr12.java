...
class Wordd { // 영어 단어와 한글 단어를 쌍으로 가진 하나의 단어 표현
...
public class Tr12 {
	...
	public Tr12(String name) {
		this.name = name;
		v = new Vector<Wordd>();
		v.add(new Wordd("love", "사랑"));
		v.add(new Wordd("animal", "동물"));
		v.add(new Wordd("emotion", "감정"));
		v.add(new Wordd("human", "인간"));
		v.add(new Wordd("stock", "주식"));
		v.add(new Wordd("trade", "거래"));
		v.add(new Wordd("society", "사회"));
		v.add(new Wordd("baby", "아기"));
		v.add(new Wordd("honey", "애인"));
		v.add(new Wordd("dall", "인형"));
		v.add(new Wordd("bear", "곰"));
		v.add(new Wordd("picture", "사진"));
		v.add(new Wordd("painting", "그림"));
		v.add(new Wordd("fault", "오류"));
		v.add(new Wordd("example", "보기"));
		v.add(new Wordd("eye", "눈"));
		v.add(new Wordd("statue", "조각상"));
	}
