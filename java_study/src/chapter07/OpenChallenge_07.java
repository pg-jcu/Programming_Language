...
//
//WordQuiz 클래스 이름대신 OpenChallenge_07으로 함
//
public class OpenChallenge_07 {
	private String name; // 퀴즈 프로그램의 이름
	private Vector<Word> v;

	public OpenChallenge_07(String name) {
		this.name = name;
		v = new Vector<Word>();
	...
	// 그러므로 이 메소드가 리턴할 때는 answerIndex가 없는 ex[] 배열이 만들어지며, ex[] 배열에 대한 임의의 인덱스를
	...
	public static void main(String[] args) {
		OpenChallenge_07 quiz = new OpenChallenge_07("명품영어");
		quiz.run();
	}
